...
public class AllUser extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("</head>");
		out.println("<body>");
		out.println("<font> <center> <h1> List of users </h1> </center> </font>");
		out.println("<table cellspacing='0' width='500px' height='300px' border='3px solid black' bgcolor='skyblue' style='margin-left:auto; margin-right:auto'>");
		out.println("<tr>");
		...
		out.println("</table>");
		out.println("<font color=dodgerblue> <center> <h3> <a href = 'home.jsp'> Back to Main page </a>  </h3> </center> </font> ");
		out.println("</body>");
		out.println("</html>");
	}
